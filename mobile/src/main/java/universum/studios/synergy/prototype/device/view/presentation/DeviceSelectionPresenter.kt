...
import universum.studios.synergy.prototype.device.view.DeviceSelectionViewModel

/**
 * @author Martin Albedinsky
 */
interface DeviceSelectionPresenter : Presenter<View<DeviceSelectionViewModel>> {
