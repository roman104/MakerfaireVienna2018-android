 ...
 * *************************************************************************************************
 */
package universum.studios.synergy.prototype.analytics
...
import universum.studios.synergy.prototype.BuildConfig
import universum.studios.synergy.prototype.analytics.AnalyticsImpl.Builder
            ...
            return when(environment) {
                ENVIRONMENT_PRODUCTION -> {
                    ...
                    val crashlytics = Crashlytics.Builder()
                            .core(CrashlyticsCore.Builder().disabled(!Fabric.ENABLED).build())
                            .answers(answers)
                            .build()
                ...
                ENVIRONMENT_TEST -> Builder().addDestination(ConsoleDestination.create(Logging.logger)).build()
                else -> Builder().build()
            }
        }
    }
